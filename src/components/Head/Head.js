...
const Head = ({ children, title, description, }) => {
  ...
  return (
    <Helmet>
      ...
      <meta
        content="ui/ux agency, web 3.0 agency, ux agency, web 3.0 and development, web 3.0 and development web 3.0, web 3.0 studio, web 3.0 and development studio, web 3.0 company, web 3.0 and development company, design consultant, ui ux agency, ux ui design agency, ui design company, ux design consultancy, ui company, ux design company, ui ux design firm, ui design agency, user interface design company, ui ux company, ui ux design agency, ui design firm, ui studio, best design studios, best design and development studios, top development agencies, reactjs development, gatsbyjs development, websites, web development, front-end development"
        name="keywords"
      />
...
Head.defaultProps = {
  description: `Seamless Digital Solutions for Crypto Ventures
  Subheadline: Unlock the Potential of Blockchain and Decentralized Technologies.`,
};
